...
public class AB_AAH_584_2 {
	...
	public static void main(String[] args) {
		...
		// System.out.println("Result = " + promW/lim + " / Expected = 5.78688636 /
		// Error = " + (promW/lim - 5.78688636));
		// System.out.println("Result = " + promJ/lim + " / Expected = 8.48967364 /
		// Error = " + (promJ/lim - 8.48967364));
		...
		for (int i = lp - d; i <= lp; i++) {
			for (int ii = 0; ii <= d; ii++) {
				...
				if (suma >= s) {
					...
					/*
					 * for (int p = 0; p < y.length; p++) { System.out.print(y[p]); }
