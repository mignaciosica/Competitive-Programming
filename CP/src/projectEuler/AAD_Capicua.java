...
/*
 * numLet = Integer.toString(num); while(i<numLet.length()/2){
 * if(numLet.charAt(numLet.length()-1) == numLet.charAt(0)){
 * System.out.println("No Funco una pija "+numLet); i++; numLet =
 * numLet.substring(i,numLet.length()-i);
 * System.out.println("A ver ahora "+numLet); } i++;
 * 
 * } i = 0; num--;
 * 
 */